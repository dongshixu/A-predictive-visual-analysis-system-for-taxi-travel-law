...
! function(t, e) {
	...
	function c(t, e, i, s) {
		var n = a(e),
			o = l(i, s),
			u = (t + "?" + n).length;
		if (u <= 2e3 && r.cors ? o.open("GET", t + "?" + n) : u > 2e3 && r.cors && (o.open("POST", t), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8")), void 0 !== s && null !== s && void 0 !== s.options && (o.timeout = s.options.timeout), u <= 2e3 && r.cors) o.send(null);
		else {
	...
	function z(t) {
		...
		if (i && i.attributionControl && s) {
			...
			c.innerHTML = r, c.style.maxWidth = G(i), i.fire("attributionupdated", {
				attribution: r
			})
		}
	}
	...
	var rt = Y.extend({
		...
		addFeature: function(t, e, i) {
			return delete t.id, t = A(t), this.post("addFeatures", {
				features: [t]
			}, function(t, s) {
		...
		updateFeature: function(t, e, i) {
			return t = A(t, this.options.idAttribute), this.post("updateFeatures", {
				features: [t]
			}, function(t, s) {
	...
	var ot = "https:" !== window.location.protocol ? "http:" : "https:",
		at = e.TileLayer.extend({
			statics: {
				TILES: {
					Streets: {
						urlTemplate: yt + "//{s}.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}",
						options: {
							minZoom: 1,
							maxZoom: 19,
	...
	var dt = e.Layer.extend({
		...
		_addCells: function(t) {
			...
			var l = n.length;
			if (0 !== l)
				for (this._cellsToLoad += l, this._cellsTotal += l, n.sort(function(t, e) {
	...
	var ft = dt.extend({
			...
			setWhere: function(t, i, s) {
				...
				for (var r = [], n = [], o = 0, a = null, l = e.Util.bind(function(t, l) {
						if (t && (a = t), l)
							for (var u = l.features.length - 1; u >= 0; u--) n.push(l.features[u].id);
			...
			createLayers: function(t) {
				for (var e = t.length - 1; e >= 0; e--) {
					...
					this._visibleZoom() && r && !this._map.hasLayer(r) && (this._map.addLayer(r), this.fire("addfeature", {
						feature: r.feature
					}, !0)), r && this.options.simplifyFactor > 0 && (r.setLatLngs || r.setLatLng) && this._updateLayer(r, s), r || ((i = this.createNewLayer(s)).feature = s, i.addEventParent(this), this.options.onEachFeature && this.options.onEachFeature(i.feature, i), this._layers[i.feature.id] = i, this.setFeatureStyle(i.feature.id, this.options.style), this.fire("createfeature", {
						feature: i.feature
